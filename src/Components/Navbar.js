    ...
    <header className="bg-gray-800 md:sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700	flex flex-wrap items-center text-base justify-center">
          ...
          <a href="#contact" className="ml-10 text-xl py-1 px-3 focus:outline-non hover:bg-gray-700 rounded">
            Contact Me
          </a>
          <a href="https://medium.com/@sppradyoth" target="_blank" rel="noopener noreferrer" className="ml-10 text-xl py-1 px-3 focus:outline-non hover:bg-gray-700 rounded">
            My Blog
          </a>
        </nav>
        <a
